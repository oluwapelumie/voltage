...
const feature_contents = {
  ...
  title:'Specialist in avoiding clients of financial',
  ...
  feature_lists:[
    {
      ...
      subtitle:<>Our fast working process ensures that your project moves smoothly from concept to completion,  <br/> without compromising on creativity or attention to detail.</>,
    },
    {
      id:2,
      icon:<FeatureTwo/>,
      title:'Dedicated team',
      subtitle:<> Our team consists of skilled designers, developers, programmers, <br/>  and project managers who work collaboratively to bring our clients' visions to life.</>,
    },
    {
      id:3,
      icon:<FeatureThree/>,
      title:'24/7 hours support',
      subtitle:<>With our 24/7 support, you can have peace of mind knowing that we are always just a message or call away, <br/>ready to help you bring your creative vision to life.</>,
    },
  ]
}
