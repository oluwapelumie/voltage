...
const footer_contents = {
  ...
  text: 'We are a team of talented professionals dedicated to bringing your creative visions to life. With our expertise in design, branding, developing, and digital solutions, we strive to deliver captivating and impactful experiences for your brand.',
  btn_text: 'Contact us',
  copy_right_text: <>© {new Date().getFullYear()} Voltage, All Right Received.</>,
  ...
  social_links: [
    {icon: 'fab fa-linkedin-in',link: 'https://www.linkedin.com/voltage-design-agency' },
    {icon: 'fab fa-instagram',link: 'https://www.instagram.com/voltage_design1' },
  ],
}
